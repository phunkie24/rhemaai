...
const caseStudies = [
  ...
  caseStudy({ slug: 'adso-azure-synapse-migration-seplat', industry: 'Data Engineering', client: 'MySQL to Azure Synapse Migration - Seplat', kpi1: { value: 'Full', label: 'Data Migration' }, kpi2: { value: 'Zero', label: 'Business Disruption' }, summary: 'Migration of MySQL data to Azure Synapse with full data fidelity, schema translation, delta load engineering, and post-migration validation, enabling cloud-native analytics on operational data.', tags: ['MySQL', 'Azure Synapse', 'ADF', 'Spark', 'Data Migration'] }),
