...
const LEGAL_COPY = {
  privacy: {
    ...
    sections: [
      ...
      ['Your choices', 'You can request access, correction or deletion of personal information by contacting hello@rhemaai.tech.'],
    ],
  },
  terms: {
    label: 'Terms',
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.content}>
        ...
        <p>
          For questions about this page, contact <a href="mailto:hello@rhemaai.tech">hello@rhemaai.tech</a>.
        </p>
      </section>
    </div>
  )
