...
const INDUSTRIES = [
  { icon: '⛽', label: 'Oil & Gas',                 highlight: true },
  { icon: '🏦', label: 'Financial Services',         highlight: false },
  { icon: '🏥', label: 'Healthcare & Life Sciences', highlight: false },
  { icon: '🏭', label: 'Manufacturing',              highlight: false },
  { icon: '📡', label: 'Telecommunications',         highlight: false },
  { icon: '🏛️', label: 'Government & Public Sector', highlight: false },
  { icon: '🛍️', label: 'Retail & E-Commerce',       highlight: false },
  { icon: '🚚', label: 'Logistics & Supply Chain',   highlight: false },
  { icon: '⚡', label: 'Energy & Utilities',         highlight: true },
  { icon: '🎓', label: 'Education & EdTech',         highlight: false },
  { icon: '🛡️', label: 'Insurance & InsurTech',     highlight: false },
  { icon: '🏢', label: 'Real Estate & PropTech',     highlight: false },
  { icon: '🌾', label: 'Agriculture & AgriTech',     highlight: false },
  { icon: '✈️', label: 'Aviation & Transport',       highlight: false },
  { icon: '📱', label: 'Technology & SaaS',          highlight: true },
]
...
const CASE_STUDIES = [
  {
    ...
    desc: 'SAP ECC → ADLS Gen2 → Databricks Bronze-Silver-Gold pipeline covering EAM, SRM, and SunSystems. Full medallion architecture with Azure Synapse Analytics.',
  ...
  return (
    <section className={styles.section}>
      <SectionHeader
        ...
        subtitle="Deep domain expertise meets cutting-edge AI and cloud engineering — across the industries that matter most."
      />
